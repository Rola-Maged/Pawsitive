...
exports.createProduct = async(req,res)=>{
    const { name, code, details, price, quantity, rating, review, image, color, material, category, sustainable } = req.body;
    const { error } = productValidate({ name, code, details, price, quantity, rating, review, image,  color,   material, category, sustainable});
